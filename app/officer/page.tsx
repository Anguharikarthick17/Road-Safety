  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', overflowX: 'hidden' }}>
      ...
      <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 0 }}>
        <div style={{ position: 'absolute', top: '20%', left: '5%', width: '500px', height: '500px', borderRadius: '50%', background: 'rgba(220,38,38,0.04)', filter: 'blur(130px)' }} />
      ...
      >
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          <h1 style={{ color: '#0f172a', fontWeight: 900, fontSize: 'clamp(22px,3vw,32px)', letterSpacing: '-1px', margin: 0 }}>
            ...
            <span style={{ background: 'linear-gradient(135deg,#dc2626,#b91c1c)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}> — Live Operations</span>
          </h1>
        </div>
