      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '18px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <div>
            ...
            <div style={{ color: '#475569', fontSize: '11px' }}>Auto-updating every 8 seconds</div>
          </div>
        </div>
          ...
          {incidents.map((inc, i) => {
            ...
            return (
              <motion.div
                ...
                style={{
                  background: `linear-gradient(135deg, ${sev.bg}, rgba(255,255,255,0.015))`,
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '10px', marginBottom: '10px' }}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                      <span style={{ display: 'flex', alignItems: 'center', gap: '4px', color: '#64748b', fontSize: '11px' }}>
